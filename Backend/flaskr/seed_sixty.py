...
def parse_line(line: str):
    ...
    fatherForeignBorn_code=line[100:101].strip()
    motherForeignBorn_code=line[102:103].strip()
    ...
    monthBorn=line[103:105].strip()
    monthMarried=line[105:107].strip()
    ...
    return Seventy(
        ...
        fatherForeignBorn=decode(fatherForeignBorn_code, ATTSCH),
        motherForeignBorn=decode(motherForeignBorn_code, ATTSCH),
...
def seed_seventy_database():

    if Seventy.query.first():
        print("Database already seeded.")
        return

    print("Seeding database with the data of seventy...")

    records = []

    BASE_DIR = os.path.dirname(__file__)
    file_path = os.path.join(BASE_DIR, "..", "data", "seventy.txt")
